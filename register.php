...
$form_age = $_POST['age'];
$form_visit_address = $_POST['visit_address'];
$form_gift_preference = $_POST['gift_preference'];
$form_phone_number = $_POST['phone_number'];
$form_email = $_POST['email'];
$form_date_of_visit = $_POST['date_of_visit'];
$form_time_of_visit = $_POST['time_of_visit'];
$form_about_child = $_POST['about_child'];
...
// $to = 'stephensajose@gmail.com';
							...
							<table width='685' height='354' align='center' cellpadding='0' cellspacing='0'>
							  ...
							  <td align='left' style='font-family:lucida grande, vedana Ref, calibri; font-size:14px; background-color: #f9f9f9; padding: 6px;'>
								  ...
								  <strong>Age</strong>: $form_age</br>
								  <strong>Address to be visited</strong>: $form_visit_address</br>
								  <strong>Gift Preference</strong>: $form_gift_preferences</br>
								  <strong>Phone Number</strong>: $form_phone_number</br>
								  <strong>Email Address</strong>: $form_email</br>
								  <strong>Date Of Visit</strong>: $form_date_of_visit</br>
								  <strong>Time Of Visit</strong>: $form_time_of_visit</br>
								  <strong>About Child</strong>: $form_about_child</br>
...
if (!empty($form_email)) { // this line checks that we have a valid email address
	...
	echo "<div class='alert alert-success'><i class='fa fa-exclamation-triangle'></i> Hello <strong>$form_name,</strong> We have received your booking, you will be contacted shortly</div>"; 
	// success message
